...
('Газонокосилка бензиновая', '2014', 5, 7990, 2),
('Газонокосилка бензиновая', '2019', 5, 19500, 2),
('Газонокосилка бензиновая', '2020', 5, 12000, 4),
('Газонокосилка бензиновая', '2018', 5, 25000, 1),
('Газонокосилка бензиновая', '2022', 5, 13000, 4),
('Газонокосилка электро', '2018', 5, 5500, 6),
('Газонокосилка аккум', '2019', 5, 12000, 1),
('Газонокосилка электро', '2020', 5, 4000, 1),
('Газонокосилка электро', '2022', 5, 6500, 1),
('Газонокосилка электро', '2023', 5, 7500, 7),
('Газонокосилка электро', '2017', 5, 6000, 1),
('Газонокосилка электро', '2017', 3, 3000, 1),
('Газонокосилка электро', '2021', 5, 4000, 9),
('Триммер', '2010', 7, 12000, 1),
('Триммер', '2014', 7, 6000, 1),
('Триммер', '2017', 7, 6000, 1),
('Триммер аккум', '2020', 7, 5655, 2),
('Триммер бензо', '2021', 5, 5000, 1),
('Мотоблок', '2010', 12, 25000, 1),
('Мотоблок', '2013', 7, 22200, 2),
('Почвоизмельчитель', '2020', 15, 3490, 1),
('Бензоопрыскиватель', '2012', 8, 30000, 7),
('Бензопила', '2016', 7, 16000, 1),
('Бензопила', '2014', 7, 34000, 3),
('Бензопила', '2021', 5, 6691, 3),
('Элетропила на штанге', '2018', 10, 5000, 1),
('Сучкорез на палке', '2017', 5, 500, 1),
('Насадка на бензопилу', '2017', 5, 2000, 1),
('Секатор телескопический', '2021', 7, 12000, 1),
('Электрокронорез', '2022', 10, 5000, 2),
('Секатор телескопический', '2023', 7, 3000, 1),
('Секатор для штанги', '2023', 5, 2200, 3),
('Секатор', '2023', 7, 3000, 2),
('Высоторез', '2023', 7, 12000, 7),
('Пила для высотореза', '2023', 7, 4000, 1),
('Ножёвка телескопическая', '2023', 7, 3500, 1),
('Пылесос', '2014', 7, 14000, 1),
('Пылесос', '2017', 7, 4500, 9),
('Пылесос', '2019', 7, 3000, 1),
('Штанговые бензоножницы', '2019', 15, 40000, 1),
('Электроножницы', '2022', 7, 12000, 1),
('Электроножницы', '2016', 7, 5000, 5),
('Бензиновые ножницы', '2012', 7, 11000, 5),
('Мотоножницы', '2022', 9, 26490, 1),
('Электрокусторез', '2022', 7, 12000, 3),
('Бензиновые ножницы', '2023', 7, 40000, 2),
('Электрокусторез', '2023', 7, 10000, 1),
('Бензиновые ножницы', '2024', 7, 28000, 1),
('Бензомотопомпа мини', '2011', 7, 6500, 1),
('Заборный шланг к минипомпе с фильтром', '2019', 7, 1600, 1),
('Заборный шланг к большой помпе', '2021', 7, 2000, 1),
('Мотопомпа мини', '2019', 7, 6000, 1),
('Рукав пожарный красный (латекс)', '2020', 10, 6000, 1),
('Бензомотопомпа мини', '2020', 7, 8500, 1),
('Бензопомпа', '2022', 7, 21500, 2),
('Аэратор', '2021', 7, 16000, 5),
('Ножницы для травы электрические', '2014', 3, 5000, 2),
('Ножницы для травы электрические', '2016', 3, 3000, 3),
('Ножницы для травы электрические', '2018', 3, 6500, 4),
('Ножницы для травы электрические аккум', '2018', 3, 3500, 3),
('Ножницы для травы ручные', '2022', 5, 1000, 3),
('Ножницы для травы ручные', '2023', 4, 1500, 3),
('Насадка на бур 200мм.', '2020', 9, 2500, 2),
('Бензобур', '2021', 9, 16000, 3),
('Удлинитель для бура 0,5м.', '2023', 15, 1000, 2),
('Удлинитель для бура 1м.', '2023', 15, 1000, 1),
('Бурдля мёрзлой земли 150мм.', '2023', 15, 3750, 2),
('Тачка с безкаменым колесом', '2018', 3, 3000, 1),
('Тачка', '2020', 12, 10000, 7),
('Колесо 1шт.', '2020', 12, 4000, 1),
('Секатор', '2022', 5, 1100, 37),
('Ножницы для цветов', '2023', 7, 1427, 2),
('Секатор', '2023', 5, 550, 6),
('Мотыжка ручная 6,5см. с 3мя зубьями', '2019', 10, 719, 8),
('Мотыжка ручная 6см. с 2мя зубьями', '2021', 10, 780, 2),
('Опрыскиватель 5л.', '2016', 7, 1000, 17),
('Опрыскиватель 5л.', '2020', 5, 800, 2),
('Опрыскиватель аккумуляторный 12л.', '2021', 5, 2300, 3),
('Опрыскиватель аккумуляторный 10л.', '2022', 5, 2500, 1),
('Опрыскиватель 3л.', '2022', 5, 300, 1),
('Опрыскиватель аккумуляторный 16л.', '2022', 5, 3000, 1),
('Опрыскиватель аккумуляторный  16л.', '2023', 7, 3470, 4),
('Опрыскиватель', '2023', 7, 3000, 7),
('Грабли веерные', '2021', 3, 1850, 28),
('Грабли планировочные', '2018', 7, 1800, 3),
('Грабли для отчистки газона', '2021', 7, 1868, 6),
('Лопата рельсовая', '2019', 3, 400, 1),
('Соперная лопата', '2016', 7, 500, 2),
('Лопата штыковая', '2020', 5, 900, 20),
('Лопата для снега', '2021', 7, 1500, 5),
('Лопата совковая', '2021', 3, 650, 5),
('Штык', '2022', 3, 711, 2),
('Лопата штыковая', '2022', 5, 1550, 10),
('Лопата штыковая', '2023', 7, 1850, 18),
('Лопата сопёрная', '2023', 7, 1050, 3),
('Лопата мини', '2023', 7, 1300, 1),
('Сучкорез', '2017', 7, 1650, 13),
('Сучкорез', '2022', 7, 3000, 8),
('Сучкорез', '2023', 7, 1775, 2),
('Извлекатель сорняков', '2016', 10, 2000, 1),
('Вилы для прокола газона', '2018', 7, 850, 1),
('Рохля 2000кг.', '2012', 15, 10000, 1),
('Станок для заточки', '2016', 10, 2000, 1),
('Огнетушитель 5л.', '2016', 5, 500, 1),
('Тиски 3,5кг.', '2017', 15, 1000, 1),
('Распылитель пожарный', '2010', 15, 2500, 1),
('Дозатор для внесения удобрений', '2015', 10, 2500, 1),
('Рохля 2500кг.', '2015', 15, 14000, 1),
('Тренога с 2-мя лебёдками 800кг.', '2015', 10, 3000, 1),
('Щиты 4шт. для пересадки', '2015', 15, 12000, 1),
('Виброплита', '2019', 10, 23000, 1),
('Насос скважинный', '2019', 7, 5880, 1),
('Бак для воды 3л.', '2019', 20, 23000, 1),
('Сажалка для луковичных', '2019', 7, 550, 1),
('Пила', '2020', 7, 3000, 1),
('Виброплита бензиновая', '2021', 10, 20000, 1),
('Болторез', '2021', 10, 3000, 1),
('Кёрхер', '2019', 10, 5000, 1),
('Бак 250л.', '2021', 15, 4000, 1),
('Бочка 750л.', '2018', 15, 7000, 1),
('Станок для заточки цепей', '2023', 10, 4300, 1),
('Удлинитель 20м.', '2017', 7, 700, 8),
('Удлинитель 30м.', '2017', 7, 1200, 1),
('Катушка без проводов', '2017', 7, 1000, 1),
('Удлинитель без катушки', '2017', 7, 800, 1),
('Удлинитель 20м.', '2021', 7, 1800, 28),
('Удлинитель 30м.', '2023', 7, 2000, 9),
('Канистра 10л.', '2016', 10, 1000, 5),
('Канистра 20л.', '2018', 10, 2000, 1),
('Канистра 5л.', '2019', 10, 1250, 10),
('Ножницы для живой изгороди', '2014', 10, 2000, 7),
('Кусторез', '2020', 5, 1200, 4),
('Кусторез', '2021', 5, 1000, 1),
('Ножницы многофункциональные', '2022', 7, 1800, 1),
('Кусторез ручной', '2023', 7, 1803, 5),
('Кусторез', '2023', 10, 2780, 5),
('Грабли', '2019', 5, 479, 5),
('Грабли ручные', '2021', 7, 780, 3),
('Грабли веерные ручные', '2023', 3, 918, 5),
('Совок для прополки', '2018', 7, 530, 13),
('Корнеудалитель', '2018', 7, 530, 1),
('Совок цветочный', '2019', 5, 659, 15),
('Cовок цветочный', '2018', 7, 300, 1),
('Мотыга', '2017', 10, 1650, 6),
('Рыхлилка', '2017', 10, 800, 2),
('Тяпка', '2017', 10, 1100, 1),
('Щётка для дорожек', '2017', 7, 1500, 2),
('Сеялка', '2017', 10, 2500, 1),
('Тяпка', '2018', 7, 600, 1),
('Прореживатель на колёсах GARDENA', '2015', 15, 3900, 1),
('Тяпка рыхлилка', '2019', 7, 1000, 1),
('Прореживатель', '2018', 10, 1700, 17),
('Лестница раскладная', '2010', 15, 9000, 3),
('Стремянка', '2019', 5, 2000, 2),
('Каток', '2016', 10, 4500, 4),
('Грабли', '2018', 7, 1070, 23),
('Грабли изогнутые', '2021', 7, 1268, 3),
('Грабли', '2022', 7, 2000, 4),
('Палка', '2019', 15, 0, 55),
('Кирка', '2015', 10, 1000, 4),
('Лом', '2015', 10, 1000, 1),
('Молот', '2023', 10, 650, 2),
('Гвоздодёр Matrix', '2023', 10, 900, 1),
('Кирка', '2023', 10, 1000, 2),
('Молот', '2023', 10, 600, 6),
('Гвоздодёр', '2023', 10, 798, 1),
('Лом', '2023', 10, 1253, 1),
('Дождеватель', '2018', 10, 2000, 1),
('Шланг', '2023', 7, 2500, 14),
('Дождеватель', '2022', 7, 2000, 1),
('Топор-колун', '2019', 7, 3000, 9),
('Топор', '2023', 7, 1348, 5),
('Кувалда', '2019', 7, 650, 9),
('Тяпка кованная', '2022', 7, 500, 5),
('Тяпка ручная', '2023', 7, 800, 8),
('Плоскорез', '2023', 7, 750, 1),
('Ножовка мини', '2021', 5, 500, 4),
('Ножовка складная', '2022', 5, 2500, 2),
('Ножовка', '2022', 5, 650, 4),
('Пила с изогнутым полотном', '2023', 5, 1700, 2),
('Пила с прямым полотном', '2023', 5, 3930, 1),
('Уровень строительный', '2017', 10, 1000, 1),
('Рулетка 5м.', '2019', 5, 200, 5),
('Рулетка 30м.', '2019', 5, 400, 3),
('Линейка вертикальная 2м.', '2020', 10, 3000, 1);
...
BEGIN
  WHILE I <= (SELECT COUNT(*) FROM DEPARTURE) LOOP -- идем по дням
    ...
    if col_emp_with_eq > 0 then
	    ...
	    array_id_eq := array[]::integer[];
	    array_count_eq := array[]::integer[];
	   
   		j=1;
	    while j <= col_emp_with_eq loop -- идем по садовникам
	      col_eq := ROUND((RANDOM()*(4-1)+1)::integer); -- количество оборудования у одного садовника (max 4 оборудования может взять садовник)
          ...
          array_id_eq = array_id_eq || id_eq;
          array_count_eq = array_count_eq || count_eq;
	
	        insert into equipment_on_departure(dep_id, emp_id, eq_id, eq_count, return_eq)
	        values (i, array_id_emp[j], id_eq, count_eq, 'T'); -- T - взял , R - вернул 
	    ...
	    if ARRAY_LENGTH(array_id_eq, 1) > 0 then		      
		    for k in 1..ARRAY_LENGTH(array_id_eq, 1) loop
			  begin
          IF (SIGN(RANDOM()-0.95) = -1) THEN 
            update EQUIPMENT 
            set eq_count = eq_count + array_count_eq[k] where eq_id = array_id_eq[k];
    
            update equipment_on_departure
            set return_eq = 'R' where dep_id = i and eq_id = array_id_eq[k];
          end if;
        end;
        commit;
        end loop;
